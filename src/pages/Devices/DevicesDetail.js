              ...
              <div className="row">
                <div className="col-lg-6 col-md-12">
                  ...
                  <div className="devices-show">
                    <img
                      src={showiphoneSilver}
                      alt=""
                      style={{ width: '60px' }}
                    />
                    <img
                      src={showiphonePurple}
                      alt=""
                      style={{ width: '60px' }}
                    />
                    <img
